    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('patient', 'Пациент'), ('doctor', 'Врач'), ('admin', 'Администратор клиники'), ('sysadmin', 'Системный администратор')], default='patient', max_length=10, verbose_name='Роль')),
